...
class test_usrp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_usrp")
        ...
        self.qtgui_time_sink_x_0_2_2 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "The bits message after FM mod and demod", #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_time_sink_x_0_2_2.set_update_time(0.10)
        self.qtgui_time_sink_x_0_2_2.set_y_axis(-5, 5)

        self.qtgui_time_sink_x_0_2_2.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_2_2.enable_tags(True)
        self.qtgui_time_sink_x_0_2_2.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "")
        self.qtgui_time_sink_x_0_2_2.enable_autoscale(False)
        self.qtgui_time_sink_x_0_2_2.enable_grid(False)
        self.qtgui_time_sink_x_0_2_2.enable_axis_labels(True)
        self.qtgui_time_sink_x_0_2_2.enable_control_panel(False)
        self.qtgui_time_sink_x_0_2_2.enable_stem_plot(False)
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_time_sink_x_0_2_2.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_sink_x_0_2_2.set_line_label(i, labels[i])
            self.qtgui_time_sink_x_0_2_2.set_line_width(i, widths[i])
            self.qtgui_time_sink_x_0_2_2.set_line_color(i, colors[i])
            self.qtgui_time_sink_x_0_2_2.set_line_style(i, styles[i])
            self.qtgui_time_sink_x_0_2_2.set_line_marker(i, markers[i])
            self.qtgui_time_sink_x_0_2_2.set_line_alpha(i, alphas[i])
        ...
        self.qtgui_time_sink_x_0_2_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "The message modulated with 2 freqs", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0_1_0 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "FFT of the DEmodulated message", #name
            1,
            None # parent
        )
        ...
        self.connect((self.blocks_add_const_vxx_1_0_0, 0), (self.qtgui_sink_x_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.qtgui_time_sink_x_0_2_0, 0))
...
def main(top_block_cls=test_usrp, options=None):
