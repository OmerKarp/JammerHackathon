...
class Barrage_attacker(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Barrage_attacker")
...
def main(top_block_cls=Barrage_attacker, options=None):
