...
class follower_attacker(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "follower_attacker")
...
def main(top_block_cls=follower_attacker, options=None):
