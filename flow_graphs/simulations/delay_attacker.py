...
class delay_attacker(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "delay_attacker")
        ...
        self.Attacker_gain = Attacker_gain = 20

        ##################################################
        # Blocks
        ##################################################

        self._Attacker_gain_range = qtgui.Range(0, 50, 1, 20, 200)
        ...
        self.jammer_delay_attack_0 = jammer.delay_attack(400, 500, 10, samp_rate)
...
def main(top_block_cls=delay_attacker, options=None):
